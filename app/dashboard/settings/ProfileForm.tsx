...
export default function ProfileForm({ firstName, lastName, email }: Props) {
  ...
  return (
    <form action={action} className="space-y-4">
      ...
      <Field label="Email address" name="email" type="email" defaultValue={email} disabled />
      <p className="text-xs text-slate-400">Email cannot be changed here. Contact support to update it.</p>
