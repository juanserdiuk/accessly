                  ...
                  <tr key={feature as string} className="border-b border-slate-50 last:border-0">
                    ...
                    {[free, pro, agency].map((val, i) => (
                      <td key={i} className="px-4 py-3 text-center">
                        {typeof val === 'boolean' ? (
                          val ? (
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="inline text-emerald-600">
